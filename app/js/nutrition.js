...
App.nutrition = (function () {
  ...
  function profile() { return S.get("food.profile", { sex: "male", age: 30, height: 175, activity: 1.375, goalDir: "lose", goalRate: 0.5, fatPct: 30 }); }
  ...
  function computeTargets(p, weightKg) {
    ...
    const fatPct = (p.fatPct > 0 ? p.fatPct : 30) / 100;
