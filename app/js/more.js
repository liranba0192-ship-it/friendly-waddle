  ...
  function render() {
    ...
    root.innerHTML = `
      ...
      <div class="card-block">
        ...
        <p class="section-hint">גרסה <b>15</b> · טאב לימוד: 📅 שיעור יומי (כושר/תזונה/בריאות — מתחדש כל בוקר) · אנגלית · 100 שיעורי פיננסים · 100 שיעורי AI — הכל עם תזכורות חזרה · קריאת בוקר · טיימר מנוחה · התחברות · בוט עזרה 🌿</p>
      </div>
    `;
