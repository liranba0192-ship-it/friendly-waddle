  ...
  function render() {
    ...
    root.innerHTML = `
      ...
      <div class="card-block">
        ...
        <p class="section-hint">גרסה <b>14</b> · טאב לימוד: אנגלית · 100 שיעורי פיננסים · 100 שיעורי AI (מדריך מאפס למובילים) — הכל ברמות עם תזכורות חזרה · קריאת בוקר · טיימר מנוחה · התחברות · בוט עזרה 🌿</p>
      </div>
    `;
