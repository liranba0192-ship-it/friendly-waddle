...
App.more = (function () {
  ...
  function render() {
    ...
    root.innerHTML = `
      ...
      <div class="card-block">
        <h3>ℹ️ אודות</h3>
        <p class="section-hint">חלבונינץ — תדריך יומי, מעקב אימונים, יומן תזונה ושקילה.</p>
        <p class="section-hint">גרסה <b>10</b> · בוט עזרה · תזכורות · גרף שקילה צבעוני · חלוקות אימון 🌿</p>
      </div>
    `;
