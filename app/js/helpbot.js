...
App.helpbot = (function () {
  ...
  const KB = [
    { k: ["חנות", "הנחה", "לקנות", "תוספים", "קנייה", "הזמנה", "קופון"], t: "חנות והנחת מנוי",
      a: "בטאב <b>חנות 🛒</b> אפשר להזמין תוספים מחנות חלבונינץ. כשקונים מתוך האפליקציה מקבלים <b>5% הנחה</b> — היא מופעלת אוטומטית בעגלה ובקופה. אם החנות לא נטענת, לחץ «פתח בדפדפן» (גם שם ההנחה נשמרת)." },
